 ...
 * @property {string} domSelectors.hours - DOM selector for hours hand
 * @property {string} domSelectors.minutes - DOM selector for minutes hand
 * @property {string} domSelectors.seconds - DOM selector for seconds hand
...
function getSecondsDegree(time) {
	...
	const secondsDegree =
		(seconds * CLOCK_FACE_DEGREE) / CLOCK_SECONDS_IN_MINUTE_AMOUNT + HAND_INITIAL_POSITION;
...
function getMinutesDegree(time) {
	...
	const minutesDegree =
		...
		(seconds * CLOCK_FACE_DEGREE) / CLOCK_SECONDS_IN_MINUTE_AMOUNT / CLOCK_MINUTES_IN_HOUR_AMOUNT +
...
function getHoursDegree(time) {
	...
	const hoursDegree =
		...
		(minutes * CLOCK_FACE_DEGREE) / CLOCK_MINUTES_IN_HOUR_AMOUNT / CLOCK_HOURS_IN_ROUND_AMOUNT +
		HAND_INITIAL_POSITION;
